...
13. Create a interfaces.DAO class, store collection of profiles there
...
21. Write a new implementation of the interfaces.DAO classes so that all the users are stored in the database
